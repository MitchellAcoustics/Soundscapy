...
def test_accessor_validate_dataset_deprecated(data):
    ...
    assert 'The ISD accessor has been deprecated. Please use `soundscapy.isd.validate(data)` instead.' in str(
        excinfo.value)
...
def test_accessor_filter_group_ids(data):
    ...
    assert 'The ISD accessor has been deprecated. Please use `soundscapy.isd.select_group_ids()` instead.' in str(
        excinfo.value)
...
def test_accessor_filter_session_ids(data):
    ...
    assert "The ISD accessor has been deprecated. Please use `soundscapy.isd.select_session_ids()` instead." in str(
        excinfo.value)
...
def test_accessor_filter_location_ids(data):
    ...
    assert 'The ISD accessor has been deprecated. Please use `soundscapy.isd.select_location_ids()` instead.' in str(
        excinfo.value)
...
def test_accessor_location_describe(data):
    ...
    assert 'The ISD accessor has been deprecated. Please use `soundscapy.isd.describe_location()` instead.' in str(
        excinfo.value)