---
title: Soundscape Assessment Tutorial
jupyter:
  jupytext:
...
Before you can use any of the tools and functions included in a package, like soundscapy, you need to `import` it. We'll import most of what we need here at the start:
...
# Load the demo data
data = pd.read_csv(
    "https://raw.githubusercontent.com/MitchellAcoustics/Soundscapy/refs/heads/main/examples/data/DemoData.csv"
)
