...
<a href="https://colab.research.google.com/github/MitchellAcoustics/Soundscapy/blob/main/examples/IoA_Soundscape_Assessment_Tutorial_v2.ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a>
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:24:34.158489Z', start_time: '2025-05-14T23:24:32.660819Z'}
import warnings
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:24:34.328574Z', start_time: '2025-05-14T23:24:34.216293Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:24:34.353011Z', start_time: '2025-05-14T23:24:34.351100Z'}
#| colab: {base_uri: https://localhost:8080/}
data.shape
```

```{python}
#| colab: {base_uri: https://localhost:8080/, height: 326}
data.describe()
```
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:24:34.374001Z', start_time: '2025-05-14T23:24:34.371935Z'}
#| colab: {base_uri: https://localhost:8080/}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:24:34.435340Z', start_time: '2025-05-14T23:24:34.432935Z'}
#| colab: {base_uri: https://localhost:8080/}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:24:35.284400Z', start_time: '2025-05-14T23:24:35.257620Z'}
#| colab: {base_uri: https://localhost:8080/}
# Validate the data
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:24:35.333164Z', start_time: '2025-05-14T23:24:35.293624Z'}
#| colab: {base_uri: https://localhost:8080/, height: 436}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:24:35.437548Z', start_time: '2025-05-14T23:24:35.354545Z'}
valid_data.to_csv("SoundscapyResults.csv", index=False)
```
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:24:35.456769Z', start_time: '2025-05-14T23:24:35.450838Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:24:35.672574Z', start_time: '2025-05-14T23:24:35.505180Z'}
#| colab: {base_uri: https://localhost:8080/, height: 545}
subset_data = sspy.isd.select_location_ids(valid_data, ["CamdenTown", "PancrasLock"])
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:24:35.877377Z', start_time: '2025-05-14T23:24:35.686826Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:24:36.022578Z', start_time: '2025-05-14T23:24:35.913579Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:24:36.256862Z', start_time: '2025-05-14T23:24:36.031532Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:24:36.271131Z', start_time: '2025-05-14T23:15:55.417031Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:24:34.671964Z', start_time: '2025-05-14T23:24:34.490307Z'}
#| colab: {base_uri: https://localhost:8080/, height: 559}
sspy.paq_likert(valid_data, title="Distribution of PAQ Responses in the Demo Data")
```
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:24:35.251559Z', start_time: '2025-05-14T23:24:34.677723Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:34:21.050407Z', start_time: '2025-05-14T23:34:20.969219Z'}
#| colab: {base_uri: https://localhost:8080/, height: 559}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:34:35.153468Z', start_time: '2025-05-14T23:34:35.140005Z'}
# sspy.stacked_likert(...)
```
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:34:42.102693Z', start_time: '2025-05-14T23:34:42.099555Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:34:43.404158Z', start_time: '2025-05-14T23:34:43.400531Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:34:44.773329Z', start_time: '2025-05-14T23:34:44.676498Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:20:17.456473Z', start_time: '2025-05-14T23:20:16.755274Z'}
#| colab: {base_uri: https://localhost:8080/, height: 962}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:20:41.402636Z', start_time: '2025-05-14T23:20:40.624154Z'}
#| colab: {base_uri: https://localhost:8080/, height: 962}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:20:50.307625Z', start_time: '2025-05-14T23:20:50.051723Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:20:52.545844Z', start_time: '2025-05-14T23:20:52.294276Z'}
#| colab: {base_uri: https://localhost:8080/, height: 607}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:25:03.907327Z', start_time: '2025-05-14T23:25:03.573847Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:25:29.500085Z', start_time: '2025-05-14T23:25:29.244636Z'}
#| colab: {base_uri: https://localhost:8080/, height: 524}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:27:00.257221Z', start_time: '2025-05-14T23:26:59.823916Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:27:35.810920Z', start_time: '2025-05-14T23:27:33.813811Z'}
#| colab: {base_uri: https://localhost:8080/, height: 777}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:27:43.894896Z', start_time: '2025-05-14T23:27:41.872996Z'}
#| colab: {base_uri: https://localhost:8080/, height: 777}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:27:59.760870Z', start_time: '2025-05-14T23:27:59.669467Z'}
#| colab: {base_uri: https://localhost:8080/, height: 524}
# Basic scatter plot
sspy.scatter(
    valid_data,
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:28:02.948138Z', start_time: '2025-05-14T23:28:02.774013Z'}
#| colab: {base_uri: https://localhost:8080/, height: 524}
# Density plot
sspy.density(
    valid_data,
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:28:37.889784Z', start_time: '2025-05-14T23:28:37.714743Z'}
#| colab: {base_uri: https://localhost:8080/, height: 524}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:28:38.976014Z', start_time: '2025-05-14T23:28:38.580949Z'}
#| colab: {base_uri: https://localhost:8080/, height: 524}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:28:41.137518Z', start_time: '2025-05-14T23:28:40.900084Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:28:43.044673Z', start_time: '2025-05-14T23:28:42.789562Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:28:59.028211Z', start_time: '2025-05-14T23:28:58.661144Z'}
#| colab: {base_uri: https://localhost:8080/, height: 652}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:31:07.870384Z', start_time: '2025-05-14T23:31:06.862124Z'}
#| colab: {base_uri: https://localhost:8080/, height: 1000}
