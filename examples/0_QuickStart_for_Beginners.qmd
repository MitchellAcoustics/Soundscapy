...
[![Open In
Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/MitchellAcoustics/Soundscapy/blob/quarto-binder-setup/examples/_site/0_QuickStart_for_Beginners.ipynb)

Welcome to Soundscapy! This tutorial is designed for users who are new
to soundscape analysis with Python. We’ll show you how Soundscapy makes
it easy to load, process, and visualise soundscape survey data.
...
```{python}
#| quarto-private-1: {key: ExecuteTime, value: {end_time: '2025-09-17T20:52:02.852953Z', start_time: '2025-09-17T20:52:00.515723Z'}}
...
```{python}
#| quarto-private-1: {key: ExecuteTime, value: {end_time: '2025-09-17T21:03:10.746772Z', start_time: '2025-09-17T21:03:10.706469Z'}}
...
```{python}
#| quarto-private-1: {key: ExecuteTime, value: {end_time: '2025-09-17T21:04:49.075166Z', start_time: '2025-09-17T21:04:48.902455Z'}}
...
```{python}
#| quarto-private-1: {key: ExecuteTime, value: {end_time: '2025-09-17T21:06:09.894297Z', start_time: '2025-09-17T21:06:09.616280Z'}}
...
```{python}
#| quarto-private-1: {key: ExecuteTime, value: {end_time: '2025-09-17T21:06:16.485600Z', start_time: '2025-09-17T21:06:16.473386Z'}}
...
```{python}
#| quarto-private-1: {key: ExecuteTime, value: {end_time: '2025-09-17T21:07:47.437443Z', start_time: '2025-09-17T21:07:47.162583Z'}}
...
```{python}
#| quarto-private-1: {key: ExecuteTime, value: {end_time: '2025-09-17T21:07:58.250223Z', start_time: '2025-09-17T21:07:58.034523Z'}}
...
```{python}
#| quarto-private-1: {key: ExecuteTime, value: {end_time: '2025-09-17T21:09:09.614984Z', start_time: '2025-09-17T21:09:09.478864Z'}}
...
```{python}
#| quarto-private-1: {key: ExecuteTime, value: {end_time: '2025-09-17T21:09:17.682010Z', start_time: '2025-09-17T21:09:17.544Z'}}
...
```{python}
#| quarto-private-1: {key: ExecuteTime, value: {end_time: '2025-09-17T21:09:24.987881Z', start_time: '2025-09-17T21:09:24.555400Z'}}
...
```{python}
#| quarto-private-1: {key: ExecuteTime, value: {end_time: '2025-09-17T21:09:36.332197Z', start_time: '2025-09-17T21:09:35.543717Z'}}
...
```{python}
#| quarto-private-1: {key: ExecuteTime, value: {end_time: '2025-09-17T21:09:41.576645Z', start_time: '2025-09-17T21:09:41.217028Z'}}
...
```{python}
#| quarto-private-1: {key: ExecuteTime, value: {end_time: '2025-09-17T21:09:47.466179Z', start_time: '2025-09-17T21:09:47.450550Z'}}
...
```{python}
#| quarto-private-1: {key: ExecuteTime, value: {end_time: '2025-09-17T21:09:52.034399Z', start_time: '2025-09-17T21:09:51.923785Z'}}
...
```{python}
#| quarto-private-1: {key: ExecuteTime, value: {end_time: '2025-09-17T21:09:54.743664Z', start_time: '2025-09-17T21:09:53.473896Z'}}
from soundscapy import ISOPlot
...
```{python}
#| quarto-private-1: {key: ExecuteTime, value: {end_time: '2025-09-17T21:09:55.231703Z', start_time: '2025-09-17T21:09:55.204630Z'}}
data = sspy.isd.load()
data.LocationID.unique()
```

```{python}
#| quarto-private-1: {key: ExecuteTime, value: {end_time: '2025-09-17T21:09:58.545928Z', start_time: '2025-09-17T21:09:56.096897Z'}}
# 1. Load and validate data
