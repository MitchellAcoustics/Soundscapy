...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:36:31.668934Z', start_time: '2025-05-14T23:36:29.680368Z'}
#| execution: {iopub.execute_input: '2023-08-13T15:59:04.324365Z', iopub.status.busy: '2023-08-13T15:59:04.324077Z', iopub.status.idle: '2023-08-13T15:59:06.994240Z', shell.execute_reply: '2023-08-13T15:59:06.993941Z'}
# Import Soundscapy
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:36:31.934238Z', start_time: '2025-05-14T23:36:31.673459Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:36:32.034105Z', start_time: '2025-05-14T23:36:32.028681Z'}
#| execution: {iopub.execute_input: '2023-08-13T15:59:07.229603Z', iopub.status.busy: '2023-08-13T15:59:07.229511Z', iopub.status.idle: '2023-08-13T15:59:07.243861Z', shell.execute_reply: '2023-08-13T15:59:07.243597Z'}
import pandas as pd
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:36:32.103442Z', start_time: '2025-05-14T23:36:32.083742Z'}
#| execution: {iopub.execute_input: '2023-08-13T15:59:07.264726Z', iopub.status.busy: '2023-08-13T15:59:07.264642Z', iopub.status.idle: '2023-08-13T15:59:07.285762Z', shell.execute_reply: '2023-08-13T15:59:07.285519Z'}
# Filter by location
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:36:32.853974Z', start_time: '2025-05-14T23:36:32.836026Z'}
#| execution: {iopub.execute_input: '2023-08-13T15:59:07.352987Z', iopub.status.busy: '2023-08-13T15:59:07.352919Z', iopub.status.idle: '2023-08-13T15:59:07.374112Z', shell.execute_reply: '2023-08-13T15:59:07.373866Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:36:34.500600Z', start_time: '2025-05-14T23:36:34.119344Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:36:56.455694Z', start_time: '2025-05-14T23:36:56.241799Z'}
p3 = (
    ISOPlot(title=None)
    .create_subplots(
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:37:03.456726Z', start_time: '2025-05-14T23:37:02.960742Z'}
d1 = (
    ISOPlot(
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:37:08.107626Z', start_time: '2025-05-14T23:37:07.893574Z'}
sspy.jointplot(
    data=isd.select_location_ids(data, ["CamdenTown"]),
    x="ISOEventful",
    y="ISOPleasant",
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:37:11.215566Z', start_time: '2025-05-14T23:37:11.212314Z'}
df["LocationID"].unique()
```

```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:37:13.820399Z', start_time: '2025-05-14T23:37:13.354136Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:37:18.145217Z', start_time: '2025-05-14T23:37:17.493009Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:37:21.528919Z', start_time: '2025-05-14T23:37:21.058116Z'}
#| collapsed: false
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:37:28.076608Z', start_time: '2025-05-14T23:37:24.050488Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:37:32.006002Z', start_time: '2025-05-14T23:37:31.999285Z'}
data[["AdjPleasant", "AdjEventful"]].describe()
```

```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:37:37.770038Z', start_time: '2025-05-14T23:37:33.156187Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-05-14T23:37:56.376366Z', start_time: '2025-05-14T23:37:42.472639Z'}
import matplotlib.pyplot as plt
import numpy as np
